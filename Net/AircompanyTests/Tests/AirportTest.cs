...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void GetPassengerPlaneWithMaxPassengersCapacityTest() 
        {
            ...
            Assert.IsTrue(planeWithMaxPassengerCapacity.Equals(expectedPlaneWithMaxPassengersCapacity));
        }

        [Test]
        public void SortByMaxLoadCapacityofPlanesTest() 
        {
            Airport airport = new Airport(planes);
            airport.SortPlanesByMaximumLoadCapacity();
            Assert.IsTrue(airport.Planes.Zip(airport.Planes.Skip(1), (curr, next) => curr.MaxLoadCapacity <= next.MaxLoadCapacity).All(x => x));
        }
    }
}
